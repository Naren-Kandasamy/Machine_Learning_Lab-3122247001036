...
\textbf{Number of Clusters ($k$)} & \textbf{WCSS (Inertia)} & \textbf{Silhouette Score} \\ \hline
    2 & 963418.29 & 0.3815 \\ \hline
    3 & 851205.12 & 0.3042 \\ \hline
    4 & 812358.47 & 0.246 \\ \hline
    5 & 774596.03 & 0.1194 \\ \hline
    6 & 751980.97 & 0.1198 \\ \hline
    7 & 730037.78 & 0.0969 \\ \hline
    8 & 716024.77 & 0.0759 \\ \hline
\end{tabular}
\end{table}
...
\textbf{$\epsilon$} & \textbf{$minPts$} & \textbf{Clusters Found} & \textbf{Noise Points} & \textbf{Noise \%} & \textbf{Silhouette} \\ \hline
    10.0 & 5 & 8 & 2627 & 87.57\% & 0.1413 \\ \hline
    10.0 & 10 & 1 & 2783 & 92.77\% & 0.0 \\ \hline
    10.0 & 15 & 1 & 2814 & 93.8\% & 0.0 \\ \hline
    15.0 & 5 & 8 & 838 & 27.93\% & 0.2995 \\ \hline
    15.0 & 10 & 4 & 949 & 31.63\% & 0.3097 \\ \hline
    15.0 & 15 & 3 & 1037 & 34.57\% & 0.3333 \\ \hline
\end{tabular}
\end{table}
...
\textbf{Linkage} & \textbf{Silhouette Score} & \textbf{Davies-Bouldin} & \textbf{Calinski-Harabasz} \\ \hline
    Ward & 0.1279 & 2.6018 & 705.32 \\ \hline
    Complete & 0.3061 & 1.8475 & 605.26 \\ \hline
    Average & 0.3368 & 1.279 & 55.59 \\ \hline
    Single & 0.531 & 0.2969 & 11.81 \\ \hline
\end{tabular}
\end{table}
...
\textbf{Algorithm} & \textbf{Silhouette} & \textbf{Davies-Bouldin} & \textbf{Calinski-H.} & \textbf{ARI} & \textbf{NMI} \\ \hline
    K-Means (k=6) & 0.1198 & 2.317 & 741.37 & 0.4034 & 0.5582 \\ \hline
    DBSCAN & 0.3333 & 1.4767 & 737.52 & 0.284 & 0.4306 \\ \hline
